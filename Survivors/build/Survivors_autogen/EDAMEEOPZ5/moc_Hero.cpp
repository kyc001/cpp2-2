...
namespace {
struct qt_meta_tag_ZN4HeroE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4HeroE = QtMocHelpers::stringData(
    "Hero"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4HeroE[] = {
...
Q_CONSTINIT const QMetaObject Hero::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4HeroE.offsetsAndSizes,
    qt_meta_data_ZN4HeroE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4HeroE_t,
        // Q_OBJECT / Q_GADGET
...
void *Hero::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4HeroE.stringdata0))
